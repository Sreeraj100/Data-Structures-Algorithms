...
res.print()
console.log(res.search("sundar"))
console.log(res.startsWith("sh"))
console.log(res.autoC("sh"))
console.log(res.commonP())
console.log(res.longestP("shyamsundar"))
console.log(res.delete("shyam"))
// console.log(res.search("shy"))
console.log(res.startsWith("sh"))